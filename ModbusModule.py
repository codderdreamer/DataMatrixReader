...
class ModbusModule():
    ...
    def connect_modbus(self):
        try:
            self.client = ModbusSerialClient(port="/dev/ttyACM0", baudrate=9600, method = "rtu")
            self.client.connect()
...
####################################### COILS WRITE #######################################
    ...
    def open_white_led(self):
        try:
            self.set_white_light_intensity(600)
    ...
    def open_blue_led(self):
        try:
            self.set_blue_light_intensity(1000)
    ...
    def open_IR_led(self):
        try:
            self.set_IR_light_intensity(1000)
